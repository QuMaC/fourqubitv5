...
for q_no in q_list:
    ...
    with program() as IQ_blobs:
        ...
        I0_data_st = declare_stream()
        Q0_data_st = declare_stream()
        I1_data_st = declare_stream()
        Q1_data_st = declare_stream()
        ...
        I_t = declare(fixed, value=0)
        Q_t = declare(fixed, value=0)

        I0_seg = declare(fixed, size=int(num_segment))
        I1_seg = declare(fixed, size=int(num_segment))

        Q0_seg = declare(fixed, size=int(num_segment))
        Q1_seg = declare(fixed, size=int(num_segment))
        ...
        with for_(n, 0, n < 5000, n + 1):
            ...
            measure_macro_acc(qe, rr, out, I0, Q0, I0_seg, Q0_seg, rd_id, pi_12=True)
            save(I0, I0_st)
            save(Q0, Q0_st)
            ...
            measure_macro_acc(qe, rr, out, I1, Q1, I1_seg, Q1_seg, rd_id, pi_12=True)
            save(I1, I1_st)
            save(Q1, Q1_st)
